#!/bin/bash
# gpu_tuned_wheel.sh <variant> — build libraft-<variant>-cuXX +
...
# -- gpu_tuned_release.sh derives this identically, independently (they're
...
# it for the other).
RELEASE_NOTES="${PROJECT_ROOT}/RELEASE_NOTES_${SHORT_VER}_${GPU_TUNED_VARIANT}_cu${CUDA_VERSION_COMPACT}.md"
