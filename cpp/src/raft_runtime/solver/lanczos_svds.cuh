...
#include <raft_runtime/solver/lanczos_svds.hpp>

#include <optional>

#define FUNC_DEF(ValueType)                                                                       \
  ...
  {                                                                                               \
    ...
    raft::sparse::solver::sparse_lanczos_svd(handle, config, csr_matrix, singular_values, U, Vt); \
  }
