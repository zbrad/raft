#!/bin/bash
# raft_wheel_validate_rtx40xx.sh — install the built rtx40xx wheels into a
# fresh scratch venv and exercise the actual compiled extensions (not just
# import them). Run after raft_wheel_rtx40xx.sh, before publishing. Mirrors
# rtx50xx/raft_wheel_validate_rtx50xx.sh, which is fully verified end-to-end
# on real hardware; this variant is untested against real RTX 40xx hardware.
#
...
validate_wheels "${PROJECT_ROOT}/dist/rtx40xx" "3.14" "rtx40xx"
